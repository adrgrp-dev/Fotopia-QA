...
$insert_action=mysqli_query($con,"INSERT INTO `user_actions`( `module`, `action`, `action_done_by_name`, `action_done_by_id`, `photographer_id`,`pc_admin_id`,`csr_id`, `action_date`) VALUES ('Order','completed','$loggedin_name',$loggedin_id,$loggedin_id,$pc_admin_id,$csr_id,now())");
