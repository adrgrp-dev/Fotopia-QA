...
$sql = "select ' Busy ' as address,'BUSY' as title, id as orderId,id, from_datetime as start, to_datetime as end,'' as gmailEvent,'BUSY' as status from appointments where photographer_id='$photographer_id' and status=0";
