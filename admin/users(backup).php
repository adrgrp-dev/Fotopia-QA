...
<hr class="space s">
         ...
         $cnt=$start_no_users;
				...
				<td class="text-left" style=""><?php $approved=$res1['email_verified']; if($approved==0) { echo "<span style='color:red;font-weight:bold;'>Pending</span>"; } else { echo "<span style='color:green;font-weight:bold;'>Approved</span>"; } ?></td>
			...
			<div id="undefined-footer" class="bootgrid-footer container-fluid"><div class="row"><div class="col-sm-6"><ul class="pagination"><li class="first disabled" aria-disabled="true"><a href="http://localhost/Photo/admin/Users.php?page=1" class="button">«</a></li><li class="prev disabled" aria-disabled="true"><a href="<?php echo "http://localhost/Photo/admin/Users.php?page=".($_SESSION["page"]-1);?>" class="button">&lt;</a></li><li class="page-1 active" aria-disabled="false" aria-selected="true"><a href="#1" class="button"><?php echo $_SESSION["page"]; ?></a></li><li class="next disabled" aria-disabled="true"><a href="<?php echo "http://localhost/Photo/admin/Users.php?page=".($_SESSION["page"]+1);?>" class="button">&gt;</a></li><li class="last disabled" aria-disabled="true"><a href="<?php echo "http://localhost/Photo/admin/Users.php?page=".($Page_check);?>" class="button">»</a></li></ul></div><div class="col-sm-6 infoBar"><div class="infos">Showing <?php echo $start_no_users+1; ?> to <?php echo $cnt; ?> of <?php echo $total_no; ?>entries</div></div></div></div>
